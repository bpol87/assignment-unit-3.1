...
let favoriteFoods = ["pizza", "curry", "fajitas"];
...
console.log('The color list now is: ', colors);
...
console.log('the new color list is: ', colors);
...
let gemIndex = gems.indexOf('Citrine');
if (gemIndex !== -1) {
  gems[gemIndex] = 'Tourmaline';
}
console.log(gems);
